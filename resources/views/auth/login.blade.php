  ...
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form action="{{ route('login') }}" method="post">
                @csrf
                <div class="mb-4">
                    <input type="text" name="identifier" id="identifier" placeholder="Your email/phone number" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('identifier') border-red-500 @enderror" value="{{ old('identifier') }}">
